          ...
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              <div style="width: 30px; margin-right: 5px;">
                <img src="{{ asset('images/favicon.png') }}" alt="SmartStore Logo" style="width: 100%; height: auto; object-fit: cover;">
              </div>
              <div style="color: #f33;">SmartStore</div>
            </div>
      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <br>
            <address>
              <b>Admin SmartStore</b><br>
              Phone: (+84) 967 999 999<br>
              Email: SmartStore@gmail.com<br>
              Address: Đại học Giao thông vận tải Hà Nội.
            </address>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3">
            To: <br>
